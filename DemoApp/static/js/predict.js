...
function displayPredictionResult(result) {
  ...
  const resultHTML = `
    <div class="alert alert-${riskColor} mb-4" role="alert">
      ...
      <p class="mb-0">Based on your health information, you have a ${riskLevel.toLowerCase()} of d
      eveloping heart disease in the next 10 years according to the Framingham Heart Study model.</p>
    </div>
